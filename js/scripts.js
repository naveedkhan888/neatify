( function( $ ) {
    ...
    * --------------------------------------------------*/
	...
	$('#btn-loadmore').on('click',function(){
		...
		$.ajax({
			url : neatify_loadmore_params.ajaxurl, // AJAX handler
			data : {
	...
	* --------------------------------------------------*/
	...
	$('.neatify_block_hidden').hide();
	swt.on( 'change', function() {
		var parent = $(this).parents('.e-parent');
		if(this.checked) {
			parent.find('.r-switch').addClass('active');
			parent.find('.l-switch').removeClass('active');
			parent.find('.neatify_block_show').hide();
			parent.find('.neatify_block_hidden').show();
		}else{
			parent.find('.l-switch').addClass('active');
			parent.find('.r-switch').removeClass('active');
			parent.find('.neatify_block_hidden').hide();
			parent.find('.neatify_block_show').show();
		}
	});
