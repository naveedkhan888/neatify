 ...
 */
class Neatify_Post_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'XP Post Grid', 'neatify' );
	}
...
// Register the widget
Plugin::instance()->widgets_manager->register( new Neatify_Post_Grid() );