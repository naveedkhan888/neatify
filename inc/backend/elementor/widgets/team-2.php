 ...
 * Widget Name: Team 2
 */
class Neatify_Team2 extends Widget_Base{
...
// After the Neatify_Team2 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Team2() );