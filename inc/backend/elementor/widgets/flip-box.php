 ...
 */
class Neatify_Flip_Box extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Flip Box', 'neatify' ),
			]
		);
		$this->add_control(
	       'image_box',
	        [
	           'label' => esc_html__( 'Image Box', 'neatify' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Client Learning Programs', 'neatify' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => 'Description',
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Our firm has helped clients engaged in more than 100 different subsectors of the aerospace, space markets.', 'neatify' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => 'Label Button',
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( '<i class="xp-webicon-trajectory"></i> Explore More', 'neatify' ),
			]
		);
...
// After the Neatify_Flip_Box class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Flip_Box() );