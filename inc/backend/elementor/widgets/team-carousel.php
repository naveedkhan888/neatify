 ...
 */
class Neatify_Team_Carousel extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Team Carousel', 'neatify' );
	}
	...
	protected function register_controls() {
	    ...
	    $repeater->add_control(
		    'social1',
	      	[
	          	'label' => esc_html__( 'Icon Social 1', 'neatify' ),
	    ...
	    $repeater->add_control(
			'social1_link',
			[
				'label' => __( 'Link Social 1', 'neatify' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'https://twitter.com/', 'neatify' ),
				'condition' => [
					'socials' => 'yes',
				],
			]
		...
		$repeater->add_control(
		    'social2',
	      	[
	          	'label' => esc_html__( 'Icon Social 2', 'neatify' ),
                'type'  => Controls_Manager::ICONS,
                'fa4compatibility' => 'icon',
				'default' => [
	    ...
	    $repeater->add_control(
			'social2_link',
			[
				'label' => __( 'Link Social 2', 'neatify' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'https://facebook.com/', 'neatify' ),
				'condition' => [
					'socials' => 'yes',
				],
			]
		...
		$repeater->add_control(
		    'social3',
	      	[
	          	'label' => esc_html__( 'Icon Social 3', 'neatify' ),
                'type'  => Controls_Manager::ICONS,
                'fa4compatibility' => 'icon',
				'default' => [
	    ...
	    $repeater->add_control(
			'social3_link',
			[
				'label' => __( 'Link Social 3', 'neatify' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'https://pinterest.com/', 'neatify' ),
				'condition' => [
					'socials' => 'yes',
				],
			]
...
// After the Neatify_Team_Carousel class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Team_Carousel() );