 ...
 * Widget Name: Tabs
 */
class Neatify_Tabs extends Widget_Base{
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'tab_title',
			[
				'label' => __( 'Title & Description', 'neatify' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Tab Title', 'neatify' ),
				'placeholder' => __( 'Tab Title', 'neatify' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Tab Content', 'neatify' ),
				'placeholder' => __( 'Tab Content', 'neatify' ),
		...
		$this->add_control(
			'xp_tabs',
			[
				'label' => __( 'Tabs Items', 'neatify' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => __( 'Tab #1', 'neatify' ),
						'tab_content' => __( 'We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.', 'neatify' ),
					],
					[
						'tab_title' => __( 'Tab #2', 'neatify' ),
						'tab_content' => __( 'We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.', 'neatify' ),
					],
				],
...
// After the Neatify_Tabs class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Tabs() );