 ...
 * Widget Name: Button
 */
class Neatify_Features_Service extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Features Service', 'neatify' );
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
			'fservice_title',
			[
				'label' => __( 'Title & Content', 'neatify' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Service Title', 'neatify' ),
				'placeholder' => __( 'Service Title', 'neatify' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'neatify' ),
			]
		);
		$repeater->add_control(
			'link',
		...
		$this->add_control(
			'fservice_lists',
			[
				'label' => __( 'Features Service List Items', 'neatify' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'fservice_number' => __( '01', 'neatify' ),
						'fservice_title' => __( 'Title #1', 'neatify' ),
						'fservice_content' => __( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'neatify' ),
						'link' => '#',
					],
					[
						'fservice_number' => __( '02', 'neatify' ),
						'fservice_title' => __( 'Title #2', 'neatify' ),
						'fservice_content' => __( 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts digital at the heart of everything you do.', 'neatify' ),
						'link' => '#',
					],
				],
		...
		$this->add_control(
			'btn_text',
			[
				'label' => __( 'Label Button', 'neatify' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More', 'neatify' ),
			]
		);
...
// After the Neatify_Features_Service class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Features_Service() );