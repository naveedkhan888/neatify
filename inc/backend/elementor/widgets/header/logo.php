 ...
 * Widget Name: Logo
 */
class Neatify_Logo extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->add_control(
			'logo_image',
			 [
				'label' => esc_html__( 'Image', 'neatify' ),
...
// After the Neatify_Logo class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Logo() );