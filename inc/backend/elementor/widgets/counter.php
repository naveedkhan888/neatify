 ...
 * Widget Name: Counter
 */
class Neatify_Counter extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Counter 1', 'neatify' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'pos_num',
			[
				'label' => __( 'Number Position', 'neatify' ),
...
Plugin::instance()->widgets_manager->register( new Neatify_Counter() );