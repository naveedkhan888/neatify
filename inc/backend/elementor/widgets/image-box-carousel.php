 ...
 */
class Neatify_Image_Box_Carousel extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Image Box Carousel', 'neatify' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Explore More', 'neatify' ),
				'label_block' => true
			]
		);
...
// After the Neatify_Image_Box_Carousel class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Image_Box_Carousel() );