...
class Image_Card_Carousel_Widget extends Widget_Base
{
    ...
    {
        return __('XP Service Carousel', 'neatify');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => __('Image Overlay', 'neatify'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Overlay Color', 'neatify'),
                'types' => ['gradient'],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Overlay Hover Color', 'neatify'),
                'types' => ['gradient'],
        ...
        $this->add_control(
            'overlay_position',
            [
                'label' => __('Overlay Position', 'neatify'),
        ...
        $this->add_control(
            'overlay_transition',
            [
                'label' => __('Overlay Transition', 'neatify'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.1,
...
?>
        <div class="image-card-carousel"
            ...
            <div class="owl-carousel owl-theme">
                ...
                ?>
                    <div class="xpic-card">
                        <a href="<?php echo esc_url($boxes['image_box']['url']); ?>" class="class_name"></a>
