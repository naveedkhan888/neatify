...
class Triple_Widget_Container extends Widget_Base
{
    ...
    {
        return esc_html__('Triple Widget Container', 'text-domain');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control('subtitle', [
            ...
            'default' => esc_html__('Your Subtitle', 'text-domain'),
            'label_block' => true,
        ]);
        ...
        $repeater->add_control('heading', [
            ...
            'type' => Controls_Manager::TEXT,
            'default' => esc_html__('Your Heading', 'text-domain'),
            'label_block' => true,
        ]);

        $repeater->add_control('heading_tag', [
            'label' => esc_html__('Heading Tag', 'text-domain'),
            'type' => Controls_Manager::SELECT,
            'default' => 'h2',
            'options' => [
                'h1' => 'H1',
        ...
        $repeater->add_control('divider_style_heading', [
            'label' => esc_html__('Divider', 'text-domain'),
            'type' => Controls_Manager::HEADING,
            'separator' => 'before',
            'condition' => [
                'divider' => 'yes',
        ...
        $this->add_control('widgets', [
            ...
            'default' => [
                [
                    'subtitle' => esc_html__('Your Subtitle', 'text-domain'),
                    'heading' => esc_html__('Your Heading', 'text-domain'),
        ...
        $this->start_controls_section('section_style_container', [
            'label' => esc_html__('Container Style', 'text-domain'),
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label' => esc_html__('Container Width', 'text-domain'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%', 'px', 'vw'],
                'range' => [
                    '%' => [
        ...
        $this->add_responsive_control('items_gap', [
            'label' => esc_html__('Items Gap', 'text-domain'),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 20,
            ],
        ...
        $this->start_controls_section('section_style_global', [
            'label' => esc_html__('Global Widget Style', 'text-domain'),
            'tab' => Controls_Manager::TAB_STYLE,
        ]);
        ...
        $this->add_responsive_control('global_subtitle_spacing', [
            'label' => esc_html__('Spacing', 'text-domain'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 0,
        ...
        $this->add_control('global_icon_replace', [
            'label' => esc_html__('Replace All Icons', 'text-domain'),
            'type' => Controls_Manager::ICONS,
            'default' => [
                'value' => '',
                'library' => '',
        ...
        $this->add_control('global_icon_background_enable', [
            'label' => esc_html__('Icon Background', 'text-domain'),
            'type' => Controls_Manager::SWITCHER,
            'default' => '',
        ...
        $this->add_responsive_control('global_divider_thickness', [
            'label' => esc_html__('Thickness', 'text-domain'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
        ...
        $this->add_control('hover_effects_heading', [
            'label' => esc_html__('Hover Effects', 'text-domain'),
            'type' => Controls_Manager::HEADING,
            'separator' => 'before',
        ]);
        ...
        $this->add_control('widget_transition', [
            'label' => esc_html__('Transition Duration', 'text-domain'),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 0.3,
            ],
        ...
        $this->add_control('widget_scale', [
            'label' => esc_html__('Scale', 'text-domain'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
