 ...
 */
class Neatify_Post_Carousel extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Post Carousel', 'neatify' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'post_num',
			[
				'label' => __( 'Show Number Posts', 'neatify' ),
		...
		$this->add_control(
			'exc',
			[
				'label' => esc_html__( 'Excerpt Length', 'neatify' ),
				'type' => Controls_Manager::NUMBER,
				'default' => '0',
			]
		);
		$this->add_control(
			'post_thumbnail',
			[
				'label' => __( 'Thumbnail Image Size', 'neatify' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'neatify-post-thumbnail-grid',
				'options' => [
					'neatify-post-thumbnail-grid' => __( 'Default', 'neatify' ),
					'full' => __( 'Full', 'neatify' ),
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'tshow',
			[
				'label' => __( 'Slides to Show', 'neatify' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Default', 'neatify' ),
				] + $slides_show,
		...
		$this->add_control(
			'timeout',
			[
				'label' => __( 'Autoplay Timeout', 'neatify' ),
		...
		$this->add_control(
			'arrow_bg_hcolor',
			[
				'label' => __( 'Background Hover', 'neatify' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
						...
						<div class="post-inner">
							...
							<?php if ( has_post_thumbnail() ) { ?>
								<div class="entry-media">
									<?php if( $settings['show_cat'] ) { neatify_posted_in(); } ?>
							...
							<div class="inner-post">
								<?php if( !has_post_thumbnail() && $settings['show_cat'] ) neatify_posted_in(); ?>
								...
								<?php if( $settings['exc'] ) { echo '<div class="entry-summary the-excerpt">' .neatify_excerpt($settings['exc']). '...</div>'; } ?>
							</div>
...
// After the Neatify_Post_Carousel class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Post_Carousel() );