 ...
 */
class Neatify_Image_Box extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Image Box', 'neatify' );
	}
...
// After the Neatify_Image_Box class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Neatify_Image_Box() );